<script setup>
import { getAuthRole, updateAuthRole } from '@/api/ruoyi/user.js'
import useSettingsStore from '@/store/modules/settings.ts'
import $modal from '@/utils/ruoyi/modal.js'
import { parseTime } from '@/utils/ruoyi/ruoyi.js'
...
<template>
  <FaPageMain class="app-container">
    ...
    <el-table ref="roleRef" v-loading="loading" :row-key="getRowKey" :data="roles.slice((pageNum - 1) * pageSize, pageNum * pageSize)" @row-click="clickRow" @selection-change="handleSelectionChange">
