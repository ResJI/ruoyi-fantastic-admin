<script setup>
import { addData, delData, getData, listData, updateData } from '@/api/ruoyi/dict/data'
import { optionselect as getDictOptionselect, getType } from '@/api/ruoyi/dict/type'
...
async function handleClose() {
  ...
  await router.push({ name: 'dictList' })
  ...
  <FaPageMain>
    ...
    <el-table v-loading="loading" :data="dataList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="操作" align="center" width="160" class-name="small-padding fixed-width">
        <template #default="scope">
          <el-button v-auth="['system:dict:edit']" link type="primary" @click="handleUpdate(scope.row)">
            <template #icon>
              <FaIcon name="i-ep:edit" />
            </template>
            修改
          </el-button>
          <el-button v-auth="['system:dict:remove']" link type="primary" @click="handleDelete(scope.row)">
            <template #icon>
              <FaIcon name="i-ep:delete" />
            </template>
            删除
